...
export default function UserDetails(): React.JSX.Element {
    ...
    useEffect(() => {
        if (isSuccess && data && traineesObjects) {
                ...
                <div id="event-details-content">
                    <div id="event-details-info">
                        <div id="event-details-description">
                            ...
                            <p>Full Name: <span className="category-value">{specificTrainee.objectDetails.traineeData.fullName}</span></p>
                            <p>Phone-Number: <span className="category-value">{specificTrainee.objectDetails.traineeData.phoneNumber}</span></p>
                            <p>Location: <span className="category-value">{specificTrainee.objectDetails.traineeData.location}</span></p>
                            <p>Sport Style: <span className="category-value">{specificTrainee.objectDetails.traineeData.sportStyle}</span></p>
                            <p>Year of Birth: <span className="category-value">{specificTrainee.objectDetails.traineeData.yearOfBirth}</span></p>
                            <p>Health Declaration: <span className="category-value">{specificTrainee.objectDetails.traineeData.isInsured.toString()}</span></p>
                        </div>
                    </div>
                </div>
            </>
